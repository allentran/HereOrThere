...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Neighborhood.bars_last_updated'
        db.add_column(u'SiteUsers_neighborhood', 'bars_last_updated',
                      self.gf('django.db.models.fields.DateField')(auto_now=True, auto_now_add=True, default=datetime.datetime(2014, 6, 30, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Neighborhood.bars_last_updated'
        db.delete_column(u'SiteUsers_neighborhood', 'bars_last_updated')
    ...
    models = {
        ...
        u'SiteUsers.neighborhood': {
            ...
            'bars_last_updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
