...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.ig_followers'
        db.add_column(u'SiteUsers_userprofile', 'ig_followers',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'UserProfile.ig_followers'
        db.delete_column(u'SiteUsers_userprofile', 'ig_followers')
