...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Location.location_lng'
        db.delete_column(u'SiteUsers_location', 'location_lng')

        # Deleting field 'Location.location_lat'
        db.delete_column(u'SiteUsers_location', 'location_lat')

        # Adding field 'Location.lat'
        db.add_column(u'SiteUsers_location', 'lat',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Location.lng'
        db.add_column(u'SiteUsers_location', 'lng',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Location.location_lng'
        db.add_column(u'SiteUsers_location', 'location_lng',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Location.location_lat'
        db.add_column(u'SiteUsers_location', 'location_lat',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Deleting field 'Location.lat'
        db.delete_column(u'SiteUsers_location', 'lat')

        # Deleting field 'Location.lng'
        db.delete_column(u'SiteUsers_location', 'lng')
