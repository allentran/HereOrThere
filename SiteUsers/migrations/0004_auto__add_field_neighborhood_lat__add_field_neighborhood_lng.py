...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Neighborhood.lat'
        db.add_column(u'SiteUsers_neighborhood', 'lat',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Neighborhood.lng'
        db.add_column(u'SiteUsers_neighborhood', 'lng',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Neighborhood.lat'
        db.delete_column(u'SiteUsers_neighborhood', 'lat')

        # Deleting field 'Neighborhood.lng'
        db.delete_column(u'SiteUsers_neighborhood', 'lng')
