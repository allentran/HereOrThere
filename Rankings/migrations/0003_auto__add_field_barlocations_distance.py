...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BarLocations.distance'
        db.add_column(u'Rankings_barlocations', 'distance',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BarLocations.distance'
        db.delete_column(u'Rankings_barlocations', 'distance')
